...
const inputClassName = "w-full outline-none placeholder:text-foreground/40";

type InputFieldProps = ComponentPropsWithoutRef<"input"> & {
  wrapperClassName?: string;
};

type SmoothInputType = NonNullable<ComponentPropsWithoutRef<"input">["type"]>;
    ...
    <div className={cn(inputWrapperClassName, wrapperClassName)}>
      ...
      >
        <input
          ...
          ref={inputRef}
          type={activeType}
          inputMode={props.inputMode ?? (activeType === "tel" ? "numeric" : undefined)}
